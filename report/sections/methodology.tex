...
The complete 150-topic dataset (100 training + 50 validation) encompasses four primary charity categories designed to represent diverse fundraising contexts and communication challenges. The category distribution provides comprehensive representation across different cause types while ensuring sufficient within-category variation to support robust statistical analysis.

The four charity categories include: Environmental and Wildlife Conservation (representing conservation causes and wildlife protection), Human Rights and Social Justice (focusing on advocacy and civil rights), Community and Charity Support (encompassing fundraising and community programs), and Media and Broadcasting (addressing public media and educational content). Each category maintains proportional representation across both training and validation datasets, ensuring evaluation validity across diverse fundraising contexts.
...
\begin{table}[H]
    ...
    \hline
    Environmental \& Wildlife Conservation & 21 & 10 & 31 \\
    Human Rights \& Social Justice & 37 & 21 & 58 \\
    Community \& Charity Support & 24 & 10 & 34 \\
    Media \& Broadcasting & 18 & 9 & 27 \\
    \hline
...
\begin{promptbox}[title={Example Analyzer Agent Prompt Template (1/2)}]
\textbf{Role \& Goal}
...
\begin{promptbox}[title={Example Analyzer Agent Prompt Template (2/2)}]
...
\begin{verbatim}
{
  ...
  "language_features": {
    ...
    "sentence_structure": "short with detailed explanations",
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/hybrid-checklist.png}
...
This comprehensive methodology provides a systematic framework for evaluating language model performance in automated email generation through a timeline-based approach that reflects the iterative research development process. The four section structure ensures logical progression from research design through final validation, establishing a robust foundation for comparative analysis of baseline and DPO-optimized model variants.
