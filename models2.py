...
# Initialize accelerator with mixed precision and DeepSpeed
accelerator = Accelerator(mixed_precision="bf16")

def chat(model_name: str, query: str, hf_token: str = hf_token, accelerator=accelerator) -> str:
    """
    ...
    # Run inference in parallel across nodes
